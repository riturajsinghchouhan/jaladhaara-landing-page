    ...
    <div className="min-h-screen bg-[var(--color-bg)] text-[var(--color-text-primary)] font-sans overflow-x-hidden">
      ...
      <section id="home" className="relative min-h-screen flex items-center py-24 px-6 lg:px-16 xl:px-24 2xl:px-32 overflow-hidden">
        ...
        <div className="w-full grid lg:grid-cols-12 gap-8 relative z-10 mt-10">
          <div className="lg:col-span-8 flex flex-col items-start reveal">
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-[90px] xl:text-[100px] font-black leading-[1.05] tracking-tight mb-8 text-white font-display">
            ...
            <p className="text-lg sm:text-xl text-gray-300 mb-12 max-w-2xl leading-[1.7] font-normal">
            ...
            <div className="flex flex-wrap gap-3 mb-12">
              <div className="flex items-center gap-2 px-3 sm:px-4 py-2 sm:py-2.5 rounded-xl bg-[#082220]/80 border border-white/5 backdrop-blur-sm">
                ...
                <span className="text-[10px] sm:text-xs font-semibold text-white/90">Find Water in<br />Tough Areas</span>
              </div>
              <div className="flex items-center gap-2 px-3 sm:px-4 py-2 sm:py-2.5 rounded-xl bg-[#082220]/80 border border-white/5 backdrop-blur-sm">
                <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-[var(--color-primary)]/20 flex items-center justify-center">
                  <Crosshair className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[var(--color-primary)]" />
                </div>
                <span className="text-[10px] sm:text-xs font-semibold text-white/90">Advanced<br />Detection</span>
              </div>
              <div className="flex items-center gap-2 px-3 sm:px-4 py-2 sm:py-2.5 rounded-xl bg-[#082220]/80 border border-white/5 backdrop-blur-sm">
                <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-[var(--color-primary)]/20 flex items-center justify-center">
                  <ShieldAlert className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[var(--color-primary)]" />
                </div>
                <span className="text-[10px] sm:text-xs font-semibold text-white/90">Trusted by<br />1000+ Farmers</span>
              </div>
            </div>

            <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
              <button className="w-full sm:w-auto h-14 px-8 rounded-xl bg-[var(--color-accent)] text-black font-bold text-base hover:bg-[#E5BE42] transition-all flex items-center justify-center gap-2 group">
                Find Borewell Now
                <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </button>
              <button className="w-full sm:w-auto h-14 px-8 rounded-xl bg-transparent border border-gray-400 text-white font-semibold text-base hover:bg-white/5 transition-all flex items-center justify-center gap-3 group">
                How It Works
      ...
      <section id="services" className="min-h-[auto] lg:min-h-screen py-12 sm:py-20 lg:py-32 px-4 sm:px-6 lg:px-16 xl:px-24 2xl:px-32 w-full relative overflow-hidden bg-[var(--color-surface)] flex flex-col justify-center">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6 lg:gap-8 reveal flex-grow content-start sm:content-center">
          {[
            ...
            <div key={i} className="bg-[#0A1615] rounded-2xl sm:rounded-[32px] overflow-hidden border border-white/5 hover:border-white/20 hover:-translate-y-2 transition-all duration-300 group shadow-lg flex flex-col h-full">
              ...
              <div className="p-3 sm:p-8 lg:p-10 pt-0 relative z-10 -mt-4 sm:-mt-12 flex-grow flex flex-col justify-end">
                <h3 className="text-sm sm:text-2xl lg:text-3xl font-bold mb-1 sm:mb-4 text-white group-hover:text-[var(--color-primary)] transition-colors leading-tight">{srv.title}</h3>
                <p className="text-gray-400 leading-relaxed text-[10px] sm:text-base lg:text-lg line-clamp-3 sm:line-clamp-none">{srv.desc}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      <section id="why-us" className="min-h-[auto] lg:min-h-screen py-12 sm:py-20 lg:py-32 px-4 sm:px-6 lg:px-16 xl:px-24 2xl:px-32 w-full relative overflow-hidden flex flex-col justify-center">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3 sm:gap-6 reveal">
          ...
          <div className="col-span-2 rounded-2xl sm:rounded-[32px] overflow-hidden border border-white/10 hover:border-white/20 transition-all flex flex-col justify-end relative group min-h-[160px] sm:min-h-[360px]">
            ...
            <div className="relative z-10 p-5 sm:p-8 lg:p-12">
              ...
              <h3 className="text-lg sm:text-2xl lg:text-3xl font-bold mb-1 sm:mb-3 text-white leading-tight">Advanced 3D Ground Scanning</h3>
              <p className="text-gray-300 text-xs sm:text-lg leading-relaxed max-w-md line-clamp-2 sm:line-clamp-none">We use military-grade geological scanners to map underground water veins with 98% accuracy before a single drop of diesel is burned.</p>
            </div>
          </div>

          {/* Bento Box 2: Tall with Image */}
          <div className="col-span-1 rounded-2xl sm:rounded-[32px] overflow-hidden border border-white/10 hover:border-white/20 transition-all flex flex-col justify-end relative group min-h-[160px] sm:min-h-[360px]">
            ...
            <div className="relative z-10 p-4 sm:p-8 lg:p-10">
              <div className="w-8 h-8 sm:w-12 sm:h-12 rounded-lg sm:rounded-xl bg-white/10 flex items-center justify-center mb-3 sm:mb-6 border border-white/20 backdrop-blur-sm group-hover:scale-110 transition-transform">
                <ShieldAlert className="w-4 h-4 sm:w-6 sm:h-6 text-white" />
              </div>
              <h3 className="text-sm sm:text-xl font-bold mb-1 sm:mb-2 text-white leading-tight">No Dry Runs</h3>
              <p className="text-gray-300 leading-relaxed text-[10px] sm:text-sm line-clamp-2 sm:line-clamp-none">Our promise is simple: we find the water first, or you don't pay for empty holes.</p>
            </div>
          </div>

          {/* Bento Box 3: Small */}
          <div className="col-span-1 bg-gradient-to-br from-[#1A1A1A] to-[#0A0A0A] rounded-2xl sm:rounded-[32px] p-4 sm:p-8 lg:p-10 border border-white/10 hover:border-white/20 transition-all flex flex-col justify-between relative overflow-hidden group min-h-[160px] sm:min-h-[auto]">
            ...
            <div className="relative z-10">
              <h3 className="text-sm sm:text-xl font-bold mb-1 sm:mb-3 text-white leading-tight">Cost Effective</h3>
              <p className="text-gray-400 leading-relaxed text-[10px] sm:text-base line-clamp-2 sm:line-clamp-none">By eliminating guesswork, we save you lakhs in wasted drilling machinery and labor.</p>
            </div>
          </div>

          {/* Bento Box 4: Wide */}
          <div className="col-span-2 bg-gradient-to-br from-[#121A2F] to-[#0B101D] rounded-2xl sm:rounded-[32px] p-5 sm:p-8 lg:p-12 border border-white/10 hover:border-white/20 transition-all flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-8 relative overflow-hidden group">
             <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] opacity-[0.03] pointer-events-none"></div>
             <div className="relative z-10">
                <h3 className="text-lg sm:text-2xl lg:text-3xl font-bold mb-2 sm:mb-4 text-white leading-tight">Join 1000+ Happy Farmers</h3>
                <p className="text-gray-400 text-xs sm:text-lg leading-relaxed max-w-md">We have successfully restored water security for hundreds of families across drought-prone districts.</p>
             </div>
      ...
      <section className="py-12 sm:py-16 lg:py-24 px-4 sm:px-6 lg:px-16 xl:px-24 2xl:px-32 w-full relative z-10 -mt-16 sm:-mt-24">
        <div className="text-center mb-8 sm:mb-16 reveal">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight max-w-4xl mx-auto leading-tight text-white drop-shadow-md">
            Smart Technology.<br />
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6 mb-8 sm:mb-20 reveal animate-fade-up-delay-1">
          {[
            ...
            <div key={i} className="bg-[var(--color-surface)] border border-white/5 rounded-2xl sm:rounded-[24px] p-4 sm:p-8 hover:bg-white/5 hover:border-white/10 transition-all duration-300 group flex flex-col justify-between">
              ...
              <div>
                <h3 className="text-[13px] sm:text-lg font-bold mb-1.5 sm:mb-3 leading-tight text-white">{item.title}</h3>
      ...
      <section id="areas" className="min-h-[auto] lg:min-h-screen py-12 sm:py-20 lg:py-32 px-4 sm:px-6 lg:px-16 xl:px-24 2xl:px-32 w-full relative overflow-hidden bg-[var(--color-bg)] border-t border-white/5 flex flex-col justify-center">
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-16 items-center relative z-10">
          <div className="max-w-xl reveal text-center lg:text-left mt-8 lg:mt-0">
            ...
            <h2 className="text-4xl sm:text-5xl lg:text-6xl xl:text-[4.5rem] font-extrabold tracking-tight text-white mb-4 sm:mb-8 leading-[1.1]">
              Wherever you are,<br className="hidden sm:block" />
              <span className="text-gray-400 font-light block sm:inline">we find water.</span>
            </h2>
            <p className="text-gray-400 text-sm sm:text-xl lg:text-2xl leading-relaxed mb-8 sm:mb-12 max-w-xl sm:pr-4">Currently operating across major agricultural and industrial belts in Central India, bringing cutting-edge groundwater detection right to your doorstep.</p>
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-2 sm:gap-4 lg:gap-5 mb-8 sm:mb-14 max-w-2xl">
              {['Indore', 'Ujjain', 'Dewas', 'Bhopal', 'Dhar', 'Khargone'].map((area, i) => (
                <div key={i} className="px-4 py-2 sm:px-6 sm:py-3 rounded-full bg-white/5 border border-white/10 text-gray-200 font-medium text-xs sm:text-lg flex items-center gap-1.5 sm:gap-2 shadow-sm">
            ...
            <button className="h-12 sm:h-14 px-6 sm:px-10 rounded-full bg-white/5 text-white font-bold text-sm sm:text-lg hover:bg-white/10 transition-all border border-white/10 flex items-center justify-center lg:justify-start gap-2 sm:gap-3 shadow-sm mx-auto lg:mx-0">
      ...
      {/* Ecosystem Apps */}
      <section id="apps" className="min-h-[auto] lg:min-h-screen py-12 sm:py-20 lg:py-32 px-4 sm:px-6 lg:px-16 xl:px-24 2xl:px-32 w-full relative overflow-hidden bg-[var(--color-surface)] flex flex-col justify-center border-t border-white/5">
        <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] opacity-[0.02] pointer-events-none"></div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-2 gap-3 sm:gap-8 lg:gap-12 max-w-6xl mx-auto w-full reveal">
          {/* User App */}
          <div className="bg-gradient-to-br from-[#06161B] to-[#0A1615] rounded-2xl sm:rounded-[40px] p-4 sm:p-10 lg:p-14 border border-white/5 hover:border-white/20 transition-all flex flex-col justify-between relative overflow-hidden group shadow-2xl">
            ...
            <div>
              ...
              <h3 className="text-base sm:text-3xl lg:text-4xl font-bold mb-2 sm:mb-4 text-white leading-tight">Jaladhaara App</h3>
              <p className="text-gray-400 text-[10px] sm:text-base lg:text-lg leading-relaxed mb-6 sm:mb-10 max-w-md line-clamp-3 sm:line-clamp-none">For Farmers and Landowners. Book groundwater scanning, track rig location, and manage your borewell projects securely from your phone.</p>
            </div>

            <div className="flex flex-col sm:flex-row flex-wrap gap-2 sm:gap-4 relative z-10 w-full">
              <button className="w-full sm:w-auto flex items-center justify-center sm:justify-start gap-2 sm:gap-3 px-3 py-2 sm:px-6 sm:py-3.5 bg-white text-black rounded-lg sm:rounded-xl hover:bg-gray-100 transition-all font-semibold shadow-lg">
                ...
                <div className="flex flex-col items-start leading-none text-left">
                  <span className="text-[8px] sm:text-[10px] text-gray-600 font-medium mb-0.5">Download on the</span>
                  <span className="text-[10px] sm:text-sm font-bold">App Store</span>
                </div>
              </button>
              <button className="w-full sm:w-auto flex items-center justify-center sm:justify-start gap-2 sm:gap-3 px-3 py-2 sm:px-6 sm:py-3.5 bg-white/5 border border-white/10 text-white rounded-lg sm:rounded-xl hover:bg-white/10 transition-all font-semibold shadow-lg">
                ...
                <div className="flex flex-col items-start leading-none text-left">
                  <span className="text-[8px] sm:text-[10px] text-gray-400 font-medium mb-0.5">GET IT ON</span>
          ...
          {/* Expert App */}
          <div className="bg-gradient-to-br from-[#121A2F] to-[#0B101D] rounded-2xl sm:rounded-[40px] p-4 sm:p-10 lg:p-14 border border-white/5 hover:border-white/20 transition-all flex flex-col justify-between relative overflow-hidden group shadow-2xl">
            ...
            <div>
              ...
              <h3 className="text-base sm:text-3xl lg:text-4xl font-bold mb-2 sm:mb-4 text-white leading-tight">Jaladhaara <span className="text-[var(--color-accent)] block sm:inline">Expert</span></h3>
              <p className="text-gray-400 text-[10px] sm:text-base lg:text-lg leading-relaxed mb-6 sm:mb-10 max-w-md line-clamp-3 sm:line-clamp-none">For Geologists and Drilling Teams. Access 3D scan data, navigate to exact coordinates, and update live project status from the field.</p>
            </div>
      ...
      {/* CTA Banner / Reviews */}
      <section id="reviews" className="px-4 sm:px-6 lg:px-16 xl:px-24 2xl:px-32 w-full mb-12 sm:mb-24 reveal">
        <div className="relative rounded-[32px] lg:rounded-[40px] overflow-hidden bg-[var(--color-bg)] border border-white/10 p-6 sm:p-10 lg:p-16 grid lg:grid-cols-2 gap-10 lg:gap-12 items-center shadow-2xl">
          <div className="absolute inset-0 z-0">
          ...
          <div className="relative z-10 mt-4 lg:mt-0">
            ...
            <p className="text-[var(--color-text-secondary)] mb-8 sm:mb-10 text-base sm:text-lg max-w-md">
          ...
          <div className="relative z-10 flex justify-center lg:justify-end pb-8 lg:pb-0">
            <div className="relative w-full max-w-[250px] sm:max-w-xs lg:max-w-sm aspect-square rounded-full bg-gradient-to-tr from-[var(--color-primary)]/20 to-transparent flex items-center justify-center border border-white/5">
              <Droplets className="w-20 h-20 lg:w-32 lg:h-32 text-[var(--color-primary)] opacity-50" />

              {/* Floating Testimonial */}
              <div className="absolute -left-2 sm:-left-8 lg:-left-24 -bottom-6 sm:bottom-4 lg:bottom-12 glass-panel p-4 sm:p-5 rounded-2xl w-[95%] sm:max-w-[280px] animate-float">
                <div className="flex gap-1 mb-2">
                  {[...Array(5)].map((_, i) => <Star key={i} className="w-3 h-3 sm:w-4 sm:h-4 fill-[var(--color-accent)] text-[var(--color-accent)]" />)}
                </div>
                <p className="text-xs sm:text-sm text-white/90 font-medium mb-2 sm:mb-3 leading-snug">"Jaladhaara Groundwater Pvt Ltd a start up company found water where two previous attempts failed. Incredible technology!"</p>
